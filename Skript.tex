...
\begin{lemma}
	Durch jeden Punkt $p$ existiert lokal eine Integralkurve von $X$ (d.\,h. es gibt ein Intervall $(-\varepsilon,\varepsilon)$, auf dem eine Integralkurve existiert), und diese ist eindeutig.
	...
	\end{proof}
\end{lemma}
Insbesondere schneiden sich verschiedene Integralkurven eines Vektorfeldes nicht (wenn sie sich schneiden, dann sind sie gleich).
\begin{defn}
...
\end{satz}
Definition Fluss, Eigenschaften. Defn. Lie-Ableitung (für Funktionen und Vektorfelder). Zeigen, dass Ableitung / Kommutator.
