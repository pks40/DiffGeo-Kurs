...
\chapter{Vektorbündel}
	...
	\section{Vektorbündel}
		...
		\begin{defn}[Vektorbündelhomomorphismen]\hfill\\
			...
			Ein Tupel $(F,f)$ mit $F:E_a\rightarrow E_b$ und $f:M_a\rightarrow M_b$ heißt \emph{Vektorbündelhomomorphismus}, wenn das folgende Diagramm kommutiert:
			\begin{center}
				\begin{tikzpicture}
	...
	\section{Konstruktionen von Vektorfeldern}
		...
		\begin{defn}
			Das zu $(E,M,\pi,\R^{n})$ duale Bündel $(E^{\prime},M,\pi^{\prime},(\R^n)^{\prime})$ ist gegeben durch
			\begin{align*}
				E^{\prime}&:=\bigcup_{x\in M}(E_{x})^{\prime}\\
				\pi^{\prime}&:E^{\prime}\rightarrow M\\
			...
			\begin{align*}
				\phi^{\prime}:(\pi^{\prime})^{-1}(U)&\rightarrow U\times (\R^n)^{\prime}\\
				\lambda&\mapsto\left(x,\lambda\circ(\pi_2\circ\phi)^{-1}\right)
			\end{align*}
		...
		\end{defn}
		\begin{bsp}
			Mit obiger Konstruktion können wir aus dem Tangentialbündel $TM$ das Kotangentialbündel $T^{\prime}M$ gewinnen. Wie wir im nächsten Kapitel sehen werden, ergeben sich in Kombination mit den folgenden Konstruktionen viele neue Strukturen.
		\end{bsp}
		\begin{defn}[Whitney-Summe]
			Die Whitney-Summe $(E_a\oplus E_b ,M,\pi,\R^{n_a+n_b})$ ist ein Vektorbündel gegeben durch
			\begin{align*}
				E_a\oplus E_b&:=\bigcup_{x\in M}E_{a,x}\oplus E_{b,x}\\
				\pi&:E_a\oplus E_b\rightarrow M\\
			...
			\begin{align*}
				\phi:\pi^{-1}(U)&\rightarrow U\times \R^{n_a+n_b}\\
				v_a\oplus v_b&\mapsto (\pi_a(v_a), \pi_2(\phi_a(v_a))\oplus\pi_2(\phi_b(v_b)))
			\end{align*}
