...
\begin{lemma}
	...
	Um eine lineare Abbildung $f$ zu definieren, können die Bilder $f(b)\in W$ für $b \in \mathcal B$ beliebig gewählt werden; die Abbildung entsteht durch sogenannte \emph{lineare Fortsetzung}.
\end{lemma}
...
\begin{lemma}[Kettenregel für Ableitungen entlang von Kurven]
