...
\epigraph{Durch $n$malige Wiederholung dieses Verfahrens wird daher die Ortsbestimmung in einer $n$fach ausgedehnten Mannigfaltigkeit auf $n$ Grössenbestimmungen [$\ldots$] zurückgeführt.}{\emph{Ueber die Hypothesen, welche der Geometrie zu Grunde liegen}\\\textsc{Bernhard Riemann}}
	\section{Topologie}
...
\epigraph{I could be bounded in a nutshell, and count myself a king of infinite space [$\ldots$].}{\textsc{Hamlet}\\\emph{Hamlet}, Akt II, Szene ii\\\textsc{William Shakespeare}}
...
{\emph{Experimental Researches in Electricity} (1831)\\\textsc{Michael Faraday}}
