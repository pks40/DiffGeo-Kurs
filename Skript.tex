...
\begin{bem}
	Ist $\gamma\colon I \to M$ eine glatte Kurve und $f\colon M \to N$ glatt, so ist $f\circ\gamma \colon I \to N$ eine Kurve in $N$. Der Geschwindigkeitsvektor von dieser Kurve zum Zeitpunkt $s$ ist $(f\circ\gamma)'(s) = \left.\DD f\right|_{\gamma(s)} (\gamma'(s))$ (Übung!).
