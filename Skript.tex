...
\chapter{Kovariante Ableitungen}
	\section{Grundlagen}
		\begin{defn}[Kovariante Ableitung]Sei $E$ ein Vektorbündel über $M$.
			...
			\end{enumerate}
		\end{defn}
		Die kovariante Ableitung ist im Fall des Tangentialbündels eine weitere Tensorderivation. Dementsprechend wird sie durch ihre Wirkung auf Vektorfeldern und Funktionen definiert. Ihren besonderen Nutzen sehen wir später im Kontext der Riemannschen Geometrie.
