...
\begin{lemma}
	...
	\begin{enumerate}[label=(\roman*)]
		...
		\item Zu jedem Punkt $p\in M$ gibt es eine offene Umgebung $W$, die nur endlich viele der $B_i$ schneidet (d.\,h. die Überdeckung $\{B_i\}_{i\in I}$ von $M$ ist \emph{lokal endlich}).
