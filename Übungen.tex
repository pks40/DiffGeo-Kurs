...
\setcounter{section}{-1}
	...
	\begin{enumerate}
		...
		\item Zeige: Die Verkettung glatter Abbildungen von Mannigfaltigkeiten ist glatt.
	...
	\begin{enumerate}
		...
		\item Sei $M \subset \R^n$ eine eingebettete Untermannigfaltigkeit, und sei $(y,U)$ eine Karte von $M$. Die durch die Identität gegebene Karte von $\R^n$ bezeichnen wir mit $x$. Berechne die Koordinatenvektoren $\left.\frac{\partial}{\partial y^i}\right|_p$ so konkret wie möglich als Vektoren in $T_pM \subset T_p\R^n \equiv \R^n$.
	\end{enumerate}
